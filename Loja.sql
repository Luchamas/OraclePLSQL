...
COMMIT //-- RA-02292: restrição de integridade (LOJA.FK_TB_COMPRAS_ID_CLIENTE) violada - registro filho localizado (o rollback é feito automaticamente)
...
ELSE
    DBMS_OUTPUT.PUT_LINE('Client NÃO localizado');
END IF;
